            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl pt-5 border border-slate-200">
                ...
                <form className="card-body" onSubmit={handleRegister}>
                    <fieldset className="fieldset">
                        <label className="label font-semibold dark:text-white">Name</label>
                        <input
                            name="name"
                            type="text"
                        ...
                        <label className="label font-semibold dark:text-white">Photo URl </label>
                        <input
                            name="photo"
                            type="text"
                            className="input dark:text-white"
                        ...
                        <button type="submit" className="btn btn-secondary mt-4 text-white">
                            Register
                        </button>
